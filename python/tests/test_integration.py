...
TEST: All 118 REST endpoints return 200 (or expected error for missing resources)
...
# ── TEST: All 118 REST endpoints return expected status ──────────────────

class TestAllEndpoints:
    """Verify all 118 REST endpoints respond correctly."""
